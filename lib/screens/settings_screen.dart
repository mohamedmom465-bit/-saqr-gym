                ...
                child: Column(
                  ...
                  children: [
                    _NumSetting(
                      ...
                      onChanged: (v) {
                        s.waterIntervalMin = int.tryParse(v) ?? 20;
                        store.save();
                      },
                    ),
                    _NumSetting(
                      ...
                      onChanged: (v) {
                        s.transitionSeconds = int.tryParse(v) ?? 45;
                        store.save();
                      },
                    ),
                    _NumSetting(
                      ...
                      decimal: true,
                      onChanged: (v) {
                        s.barWeight = double.tryParse(v) ?? 20;
                        store.save();
                      },
                    ),
              ...
              children: [
                ...
                Expanded(
                  child: _MiniField(
                    ...
                    number: true,
                    onChanged: (v) {
                      ex.rest = int.tryParse(v) ?? ex.rest;
                      store.save();
                    },
                  ),
                ),
            ...
            Row(
              children: [
                Container(
                  ...
                  child: ex.image != null
                      ? Image(image: ex.image!, fit: BoxFit.cover)
